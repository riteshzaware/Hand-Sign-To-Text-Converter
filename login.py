...
image2 = Image.open('log.png')
image2 = image2.resize((800,823), Image.ANTIALIAS)
...
title=tk.Label(root, text="Login Here", font=("Algerian", 30, "bold","italic"),bd=5,bg="#4A708B",fg="white")
title.place(x=840,y=250,width=480)
        
Login_frame=tk.Frame(root,bg="white")
Login_frame.place(x=840,y=360)
